...
U1_BC_XMIN=0;	U1_BC_XMIN_C1(1:NY)=mean(uinit(1,:,:),3); 
U2_BC_XMIN=0;	U2_BC_XMIN_C1(1:NY)=mean(vinit(1,:,:),3);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
U3_BC_XMIN=0;	U3_BC_XMIN_C1(1:NY)=0;
P_BC_XMIN=1;	P_BC_XMIN_C1(1:NY)=0;

U1_BC_XMAX=0;	U1_BC_XMAX_C1(1:NY)=mean(uinit(9,:,:),3); 
U2_BC_XMAX=0;	U2_BC_XMAX_C1(1:NY)=mean(vinit(9,:,:),3);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
U3_BC_XMAX=0;	U3_BC_XMAX_C1(1:NY)=0;
...
U1_BC_YMIN=0;	U1_BC_YMIN_C1(1:NX)=mean(uinit(:,1,:),3); 
U2_BC_YMIN=0;	U2_BC_YMIN_C1(1:NX)=mean(vinit(:,1,:),3);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
U3_BC_YMIN=0;	U3_BC_YMIN_C1(1:NX)=0;   
P_BC_YMIN=1;	P_BC_YMIN_C1(1:NX)=0; 

U1_BC_YMAX=0;	U1_BC_YMAX_C1(1:NX)=mean(uinit(:,9,:),3);
U2_BC_YMAX=0;	U2_BC_YMAX_C1(1:NX)=mean(vinit(:,9,:),3);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
U3_BC_YMAX=0;	U3_BC_YMAX_C1(1:NX)=0;
P_BC_YMAX=1;	P_BC_YMAX_C1(1:NX)=0; 

% Boundary conditions for each scalar
for n=1:N_TH
TH_BC_YMIN(n)=1;	TH_BC_YMIN_C1(1:NX,n)=0; 
TH_BC_YMAX(n)=1;	TH_BC_YMAX_C1(1:NX,n)=0; 
end
