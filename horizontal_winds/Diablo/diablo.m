...
readwinddata; % Read in boundary and initial conditions
...
movie(mov,1,20); % Play the movie once at 20 frames per second

disp(['Completed ' int2str(N_TIME_STEPS) ' timesteps ']);  % We're done!
